"""
Django settings for webwath project.
...
SECRET_KEY = 'django-insecure-!fz)+oejbtlhlmdy6vl6^g-0d86^p6lg$!phc^bw65pl*4@rkm'
...
WSGI_APPLICATION = 'webwath.wsgi.application'
